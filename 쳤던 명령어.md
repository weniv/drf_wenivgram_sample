...
pip install djangorestframework-simplejwt # 일반적으로 JWT을 사용할 수 있는 라이브러리도 있지만 여러가지 부가 설정이 쉬운 simplejwt를 사용하였습니다.
pip install drf-spectacular # 일반적으로 사용하는 drf swagger가 있으나 부가설정이 쉽고, API 테스트 뿐만 아니라 명세까지 상세하게 작성할 수 있는 spectacular를 사용했습니다.
